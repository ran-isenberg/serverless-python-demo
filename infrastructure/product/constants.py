...
STREAM_PROCESSOR_EVENT_BUS_NAME = 'events'
STREAM_PROCESSOR_EVENT_SOURCE_NAME = 'myorg.product.product_notification'
...
STREAM_PROCESSOR_TEST_TABLE_NAME = 'StreamTest'
STREAM_PROCESSOR_TEST_TABLE_NAME_OUTPUT = 'TestDbOutput'
STREAM_PROCESSOR_TEST_EVENT_BUS_NAME_OUTPUT = 'EventBusOutput'
