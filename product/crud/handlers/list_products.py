...
from product.crud.domain_logic.handle_list_request import handle_list_request
...
def list_products(event: Dict[str, Any], context: LambdaContext) -> Dict[str, Any]:
    ...
    try:
        response: ListProductsOutput = handle_list_request(table_name=env_vars.TABLE_NAME,)
